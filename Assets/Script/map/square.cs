...
public class square : MonoBehaviour {
    ...
    void OnMouseDown()
    {
        ...
        if (gameObject.tag == "OnRock" && Player.ChosenItem != null && isFull == false && GameObject.Find("Player").GetComponent<Player>().gold - Player.ChosenItem.GetComponent<turret>().cost >= 0)
        {
